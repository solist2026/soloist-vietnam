...
const faqs = [
  {
    ...
    emoji: "✈️",
    questions: [
      { q: "האם ישראלים צריכים ויזה לוייטנאם?", a: "כן! ישראל אינה פטורה מויזה. הפתרון הקל: E-Visa אונליין לפני הטיסה — $25 לכניסה אחת או $50 לכניסות מרובות. תוקף 90 יום." },
      ...
      { q: "כמה כסף לקחת לוייטנאם?", a: "תקציב יומי ממוצע: $30-50 לטיול חסכוני, $60-100 לטיול נוח. הכל כולל — לינה, אוכל ותחבורה." },
      { q: "האם וייטנאם בטוחה למטיילים ישראלים?", a: "כן מאוד! וייטנאם נחשבת לאחת המדינות הבטוחות ביותר בדרום-מזרח אסיה. פשיעה כלפי תיירים נדירה. שמרו על חפצים בשווקים." },
    ],
  },
  {
    ...
    emoji: "🚌",
    questions: [
      { q: "מה הדרך הכי טובה לנסוע בין ערים?", a: "אוטובוסי לילה (Sleeper Bus) הם הפופולריים ביותר — זולים, נוחים יחסית וחוסכים לינה. לטווחים ארוכים — טיסות פנימיות שוות כל שקל." },
      { q: "האם כדאי לשכור אופנוע?", a: "כן! זו אחת מהחוויות הכי טובות. עלות $5-8/יום. חייבים קסדה ורישיון בינלאומי. הדרך הכי חופשית לחקור." },
      { q: "איך להתמודד עם מוניות ופיקוחים?", a: "השתמשו ב-Grab בלבד! מונית רגילה בלי מד תעשה לכם מחיר תיירות. Grab — מחיר קבוע, אמין ונוח." },
  ...
  },
  {
    ...
    emoji: "🇮🇱",
    questions: [
      { q: "יש קהילה ישראלית גדולה בוייטנאם?", a: "כן! וייטנאם מאוד פופולרית בקרב ישראלים. בעיקר ב-Old Quarter האנוי, Bui Vien בסייגון ובהוי אן. תמיד תפגשו ישראלים." },
      { q: "איפה בתי חב\"ד בוייטנאם?", a: "בית חב\"ד פעיל בהאנוי (Old Quarter) ובית חב\"ד גדול בהו צ'י מין (District 1). מרכוז חשוב לישראלים — שישי, שבת, חגים ומידע כללי." },
      { q: "יש קבוצות וואטסאפ של מטיילים בוייטנאם?", a: "בהחלט! חפשו בפייסבוק 'ישראלים בוייטנאם' או 'מטיילים בוייטנאם'. גם בפורום שלנו תוכלו לשאול ולקבל עצות מניסיון אישי." },
      { q: "מה לעשות אם יש בעיה / מצוקה בוייטנאם?", a: "בית חב\"ד הוא מקום ראשון לפנות. גם שגרירות ישראל בהאנוי (+84-24-3843-3140) ועם ישראל לקונסוליה בסייגון (+84-28-3911-3090)." },
    ],
  },
];
            ...
            {[
              {
                ...
                notes: "פעיל בשישי ושבת, ארוחות, מידע לתיירים",
              },
              {
