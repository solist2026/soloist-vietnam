...
const faqs = [
  {
    ...
    emoji: "✈️",
    questions: [
      { q: "האם ישראלים צריכים ויזה לוייטנאם?", a: "כן! ישראל אינה פטורה מויזה. הפתרון הקל: E-Visa אונליין לפני הטיסה — $25 לכניסה אחת או $50 לכניסות מרובות. תוקף 90 יום. הגישו לפחות שבוע מראש. זמן עיבוד: 3-5 ימי עסקים." },
      { q: "מתי הכי כדאי לטוס לוייטנאם?", a: "עונה יבשה שונה בין האזורים — זה חשוב לדעת! צפון: אוקטובר–אפריל (חורף נעים, לא חם). מרכז: פברואר–אוגוסט. דרום: נובמבר–אפריל. הזמן הכי טוב לסיור שלם: נובמבר–ינואר." },
      ...
      { q: "האם וייטנאם בטוחה למטיילים ישראלים?", a: "כן מאוד — אחת מהמדינות הבטוחות ביותר בדרום-מזרח אסיה. אלפי ישראלים מטיילים שם כל שנה בלי תקלות. שמרו על התיק בשווקים עמוסים. הימנעו ממוניות ללא Grab. שימו לב: לא מומלץ לעבור דרך סין עם דרכון ישראלי." },
    ],
  },
  {
    ...
    questions: [
      ...
      { q: "מה זה לופ הא גיאנג ואיך מארגנים?", a: "אחד הדברים הכי מיוחדים שתעשו בחיים — מסע אופנועים 3-5 ימים דרך ההרים הצפוניים של וייטנאם. נופים שקשה להאמין שהם אמיתיים. הספקים הכי מומלצים בישראלים: Happy (האפי) ו-Kai (קאי). תקציב: ~6 מיליון VND ל-3 ימים כולל נהג, לינה ואוכל. הזמינו לפחות שבוע מראש, מתמלא מהר בעונה." },
