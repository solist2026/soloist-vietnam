...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-full z-50">
      {/* Utility bar */}
      {/* Mobile: full-width WhatsApp green bar, centered */}
      <Link
        href="/community"
        className="md:hidden flex items-center justify-center gap-1.5 h-8 bg-[#25D366] text-white font-bold text-sm w-full"
      >
        <span>לקהילת</span>
      ...
      {/* Desktop: original dark bar */}
      <div className="hidden md:block bg-[#1A2535] text-white">
        <div className="max-w-7xl mx-auto px-4 h-8 flex items-center justify-between">
          <Link
            href="/community"
            className="flex items-center gap-1 bg-[#25D366] hover:bg-[#1ea854] text-white font-bold px-3 py-0.5 rounded-full text-xs transition-colors"
          >
            <span>קהילה ב</span>
            <span dir="ltr">WhatsApp</span>
