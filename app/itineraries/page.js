...
const predefinedItineraries = [
  ...
  },
  {
    ...
    emoji: "🏆",
    type: "extended",
    route: ["האנוי", "האה גיאנג", "סאפה", "הלונג ביי", "ניין בינה", "הואה", "הוי אן", "קוי נהון", "הו צ'י מין", "מקונג", "פו קווק", "מוי נה"],
    days: [
      { day: "1-4", location: "האנוי", activities: ["עיר עתיקה", "מוזיאונים", "אוכל מקומי", "טיולי סביבה"] },
      { day: "5-8", location: "האה גיאנג", activities: ["טיול אופנוע Ma Pi Leng", "כפרי שבטים", "נופים דרמטיים"] },
    ...
    tips: "עם חודש מלא אפשר לראות גם יעדים נסתרים כמו האה גיאנג וקוי נהון.",
    budget: "$1,800-2,800",
    difficulty: "מתקדם",
  },
];
...
const recommendations = {
  ...
  "3 שבועות": {
    ...
    desc: "המסלול המושלם — ראיתי את כל האזורים המרכזיים ביחד עם זמן לנשום.",
  ...
  "חודש ויותר": {
    ...
    destinations: ["האנוי", "האה גיאנג", "סאפה", "הלונג ביי", "הואה", "הוי אן", "הו צ'י מין", "מקונג", "פו קווק", "מוי נה"],
    tip: "האה גיאנג והמחוזות הצפוניים — אחד הנופים הדרמטיים בעולם.",
  },
};
