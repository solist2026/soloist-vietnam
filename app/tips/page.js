...
const tipCategories = [
  ...
  },
  {
    ...
    tips: [
      ...
      { title: "טיסה לבנה היל (Ba Na Hills)", desc: "מדה נאנג: אוטובוס כתום של Futa — חיפוש 'Danabus' בגוגל. 30,000 VND לכל כיוון." },
    ],
  },
  {
    id: "sim",
    ...
    tips: [
      ...
      { title: "eSIM", desc: "אם הטלפון תומך — eSIM מ-Saily, Voye או MobiMatter נוח יותר. קונים מראש מישראל. יתרון: אינטרנט מהרגע שנחתתם." },
  ...
  },
  {
    ...
    tips: [
      ...
      { title: "עצירת עצרת בלופ", desc: "אם רוכבים עצמאית בלופ הא גיאנג או קאו בנג' — חייב רישיון בינלאומי. יש מחסומי משטרה." },
